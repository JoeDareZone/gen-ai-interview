...
with_node \
  ...
  --target "/Users/joe/Coding/gen-ai-interview/ios/Pods/Target Support Files/Pods-genaiinterview/ExpoModulesProvider.swift" \
  --entitlement "/Users/joe/Coding/gen-ai-interview/ios/genaiinterview/genaiinterview.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-random" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
